...
internal sealed class FlatPublicationFetcher
{
    ...
    {
        var queryString = $"?{AppConstants.Media.GetPubQueryOutputJson}&pub={normalizedPublicationCode}&fileformat={fileFormat}&alllangs=0&langwritten={normalizedLanguageCode}";
        try
        {
