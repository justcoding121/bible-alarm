...
public class VmObservable : INotifyPropertyChanged
{
    ...
    {
        foreach (var property in properties) RaiseProperty(property);
    }
...
public static class ObservableExtensions
{
    ...
    public static Assignement<TObservable, T> Set<TObservable, T>(this TObservable obs, ref T field, T value,
    ...
    /// </summary>
    /// <returns>The result of the assignment.</returns>
    public static Assignement<TObservable, T> Set<TObservable, T>(this TObservable obs, T field, T value,
        [CallerMemberName] string name = null)
        where TObservable : VmObservable
    {
        var result = new Assignement<TObservable, T>(obs, name, field, value);
