...
namespace Quartz
{
    ...
    public class CronExpression : IDeserializationCallback, ISerializable
    {
        ...
        protected CronExpression(SerializationInfo info, StreamingContext context)
        {
            ...
            switch (version)
            {
                ...
                case 1:
                    ...
                    {
                        _timeZone = TimeZoneUtil.FindTimeZoneById(timeZoneId);
                    }
                    break;
                default:
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return ((CronExpressionString != null ? CronExpressionString.GetHashCode() : 0) * 397) ^ (_timeZone != null ? _timeZone.GetHashCode() : 0);
            }
        }
    }
