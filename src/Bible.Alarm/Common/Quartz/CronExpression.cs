...
public class CronExpression : IDeserializationCallback, ISerializable
{
    ...
    protected CronExpression(SerializationInfo info, StreamingContext context)
    {
        ...
        switch (version)
        {
            ...
            case 1:
                ...
                if (!string.IsNullOrEmpty(timeZoneId)) _timeZone = TimeZoneUtil.FindTimeZoneById(timeZoneId);
                break;
            default:
    ...
    public TimeZoneInfo TimeZone
    {
        ...
        get
        {
            if (_timeZone == null) _timeZone = TimeZoneInfo.Local;
    ...
    public virtual DateTimeOffset? GetTimeAfter(DateTimeOffset afterTimeUtc)
    {
        ...
        while (!gotOne)
        {
            ...
            if (hr != t)
            {
                ...
                if (day > daysInMonth)
                    d = new DateTimeOffset(d.Year, d.Month, daysInMonth, d.Hour, 0, 0, d.Millisecond, d.Offset).AddDays(
                        day - daysInMonth);
                else
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            return ((CronExpressionString != null ? CronExpressionString.GetHashCode() : 0) * 397) ^
                   (_timeZone != null ? _timeZone.GetHashCode() : 0);
        }
    }
}
