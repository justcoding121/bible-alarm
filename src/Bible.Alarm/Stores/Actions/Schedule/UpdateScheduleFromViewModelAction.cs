...
/// </summary>
public class UpdateScheduleFromViewModelAction(ScheduleStateItem schedule, bool musicUpdated = true, bool biblePublicationUpdated = true, bool shouldSave = true)
{
