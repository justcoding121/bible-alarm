...
/// </summary>
public static class CategorySelectionAutoPopulateHarvestCheck
{
    public static async Task<bool> CheckIfPublicationWithFirstSectionHarvestedAsync(
        ILogger logger,
        MediaDbContext db,
        ...
        string normalizedLanguageCode)
    {
        ...
        {
            logger.Warning(ex, "CategorySelectionAutoPopulateHandler: Error checking if publication {PublicationCode} is harvested", publicationCode);
            return false;
        }
    }
}
