...
/// <summary>
/// Handles section harvesting for TrackNavigator when navigating to adjacent sections.
/// </summary>
public sealed class TrackNavigatorSectionHarvester
{
    ...
    public TrackNavigatorSectionHarvester(
    ...
    public async Task<bool> EnsureSectionHarvestedAsync(
        string languageCode,
        ...
        Action clearTracksCache)
    {
        ...
        {
            logger?.Warning("No internet - cannot harvest section for navigation");
            return false;
        }
        ...
        try
        {
            ...
            logger?.Warning("Failed to harvest section");
            return false;
        }
        catch (Exception ex)
        {
            logger?.Error(ex, "Error harvesting section");
            return false;
        }
    }
