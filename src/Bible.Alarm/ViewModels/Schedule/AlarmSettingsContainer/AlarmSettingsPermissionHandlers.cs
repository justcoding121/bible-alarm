...
/// Platform-specific behavior (NotificationEnabled vs IsEnabled) is provided via callbacks.
/// </summary>
public static class AlarmSettingsPermissionHandlers
{
        ...
        Action<bool> setIsWaitingForPermissionResponse)
    {
        ...
        {
            setOff();
            logger.Debug("Set to OFF after permission denied");
