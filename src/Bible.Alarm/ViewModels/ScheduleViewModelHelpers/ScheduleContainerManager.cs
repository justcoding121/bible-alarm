...
public sealed class ScheduleContainerManager
{
    ...
    public async Task InitializeContainerViewModelsAsync(
        Action<BibleSelectionContainerViewModel?, MusicSelectionContainerViewModel?, NumberOfChapterContainerViewModel?, ScheduleDetailsContainerViewModel?> setContainers)
    {
