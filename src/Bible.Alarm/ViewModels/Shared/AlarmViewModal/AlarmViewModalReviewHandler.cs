...
namespace Bible.Alarm.ViewModels.Shared.AlarmViewModal;

/// <summary>
/// Handles review request logic for AlarmViewModal.
/// Separated from AlarmViewModal for better modularity.
/// </summary>
public class AlarmViewModalReviewHandler
{
    private readonly ILogger logger;
    private readonly IGeneralSettingsService generalSettingsService;

    public AlarmViewModalReviewHandler(ILogger logger, IGeneralSettingsService generalSettingsService)
    {
        this.logger = logger;
