...
public sealed class ScheduleDisplayNameMusicHelperTests
{
    ...
    [Fact]
    public async Task PopulateAsync_early_exit_when_codes_blank()
    {
        ...
        var state = new ScheduleStateItem { Id = 2, Name = "M" };
        ...
        await sut.PopulateAsync(state, music);
