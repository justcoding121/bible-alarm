...
public sealed class ScheduleEffectsViewScheduleTests
{
...
#pragma warning restore CS0067
    ...
    [Fact]
    public async Task HandleViewSchedule_no_op_when_current_schedule_missing()
    {
        ...
        await sut.HandleViewSchedule(new ViewScheduleAction(null), dispatcher);
