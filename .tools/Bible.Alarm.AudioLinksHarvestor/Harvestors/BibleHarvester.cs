...
internal class BibleHarvester : BaseHarvester
{
    ...
    private readonly BibleLanguageDiscoveryHarvester discoveryHarvester;
        ...
        : base(logger, downloadUtility)
    {
        ...
        discoveryHarvester = new BibleLanguageDiscoveryHarvester(logger, downloadUtility, dataPersister);
    }
    ...
    {
        await discoveryHarvester.DiscoverLanguages(biblePublicationCodeToNameMappings, isTestRun);
    }
        ...
        bool isTestRun = false)
    {
        foreach (var publication in biblePublicationCodeToNameMappings)
        {
            ...
            if (allDiscoveredLanguages == null || allDiscoveredLanguages.Count == 0)
            {
                ...
                allDiscoveredLanguages = await discoveryHarvester.DiscoverLanguagesForAllBooks(publicationCode, publication.Value, isTestRun);
