...
/// <summary>
/// Base class for all harvesters providing common functionality and constants.
/// </summary>
internal abstract class BaseHarvester
{
    /// <summary>
    /// Maximum number of concurrent language downloads across all harvesters.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the BaseHarvester class.
    /// </summary>
    /// <param name="logger">Logger instance for logging operations.</param>
    /// <param name="downloadUtility">Download utility for making HTTP requests.</param>
    protected BaseHarvester(ILogger logger, DownloadUtility downloadUtility)
    {
        Logger = logger;
