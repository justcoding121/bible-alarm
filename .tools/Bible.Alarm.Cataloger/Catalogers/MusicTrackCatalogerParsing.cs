...
internal static class MusicTrackCatalogParsing
{
    internal static string BuildMusicCatalogLink(string publicationDownloadCode, string? languageCode)
    {
        ...
        return $"{AppConstants.ApiEndpoints.JwOrgIndexServiceBaseUrl}?output=json&pub={publicationDownloadCode}&fileformat={AppConstants.Media.MediaStreamFormatMp3}&alllangs=0{langParam}";
    }
