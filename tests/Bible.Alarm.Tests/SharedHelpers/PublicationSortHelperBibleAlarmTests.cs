...
public sealed class PublicationSortHelperBibleAlarmTests
{
    [Fact]
    ...
    {
        IEnumerable<BiblePublicationCodeItem>? input = null;

        Assert.Empty(PublicationSortHelper.SortByPriority(input!, static p => p.Code));
    }
